...
def main():
    ...
    # if _PYDISTILL_SETUP_SKIP_PLUGGY_DEP is set, skip installing pluggy;
    # used by tox.ini to test with pluggy master
    if '_PYDISTILL_SETUP_SKIP_PLUGGY_DEP' not in os.environ:
    ...
    setup(
        ...
        packages=['_pydistill'],
        py_modules=['pydistill'],
        zip_safe=False,
    )


class PyDistill(Command):
    user_options = []
    ...
    def run(self):
        ...
        errno = subprocess.call([sys.executable, 'pydistill.py', '--ignore=doc'])
